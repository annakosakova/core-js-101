...
function willYouMarryMe(isPositiveAnswer) {
  let answer = '';
  if (isPositiveAnswer && typeof (isPositiveAnswer) === 'boolean') answer = 'Hooray!!! She said "Yes"!';
  if (!isPositiveAnswer && typeof (isPositiveAnswer) === 'boolean') answer = 'Oh no, she said "No".';

  return new Promise((resolve, reject) => {
    if (typeof (isPositiveAnswer) === 'boolean') resolve(answer);
